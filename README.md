...
* **Насколько язык хорошо описан:** немного непонятно, как быть, если хочется переходить в другое состояние не по одному символу. В первой домашней работе это выглядело так: `Q₁: в Q₃ по 0-9`, во второй нет ничего про это, в том числе в лексере `-` отдельно не обрабатывается. А если нужен не диапазон символов, а, к примеру, `1, 5, 8`? В лексере есть обработка запятой: `t_SEP = r','`. Могу предположить, что с помощью неё предполагалось перечислять необходимые символы для перехода по ребрам, но это лишь догадка. Ни в описании, ни в примерах нет пояснений, для чего она. В четвертой домашней работе всё это исчезло, так что для каждого символа нужно отдельно прописывать переход в другое состояние. Но в остальном очень понятное и доступное описание.
  
* **Насколько язык сам по себе удобен:** немного грустно, что нужно самому считать порядковый номер символа и что для каждого символа нужно отдельно прописывать переход в другое состояние, даже если они ведут в одно и то же. Но зато по полученному коду можно представить, как выглядит автомат, не так сложно искать ошибки. Довольно удобный язык описания.

* **Если есть поддержка в среде разработки, то насколько она удобная:** была сделана подсветка не для этого языка.

* **Насколько понятные сообщения об ошибках выдает синтаксический анализатор:** довольно понятные и разнообразные сообщения об ошибках. Порадовало указание строки, где возникла ошибка и разъяснения, почему автомат не является детерминированным, в каком символе произошла ошибка и так далее, это было очень полезно.
...
* **Постараться найти ошибки: неточности описания, несоответствие работы синтаксического анализатора описанию языка, неправильные результаты:** 
  ...
  2) тесты, где анализатор выдавал бы неправильные результаты я не нашла. Тест с недетерминированным автоматом: [входные данные](https://github.com/Fawentus/fl-2021-hse-win/blob/HW04/Polushin_err_ex) - [выходные данные](https://github.com/Fawentus/fl-2021-hse-win/blob/HW04/Polushin_err_ex.out). Корректный тест: [входные данные](https://github.com/Fawentus/fl-2021-hse-win/blob/HW04/Polushin_ex) - [выходные данные](https://github.com/Fawentus/fl-2021-hse-win/blob/HW04/Polushin_ex.out)
...
1) [входные данные](https://github.com/Fawentus/fl-2021-hse-win/blob/HW04/ex1) - [выходные данные](https://github.com/Fawentus/fl-2021-hse-win/blob/HW04/ex1.out)
2) [входные данные](https://github.com/Fawentus/fl-2021-hse-win/blob/HW04/ex2) - [выходные данные](https://github.com/Fawentus/fl-2021-hse-win/blob/HW04/ex2.out)
3) [входные данные](https://github.com/Fawentus/fl-2021-hse-win/blob/HW04/ex3) - [выходные данные](https://github.com/Fawentus/fl-2021-hse-win/blob/HW04/ex3.out)
...
2) Автомат, не имеющий однозначно определенного начального состояния: [входные данные](https://github.com/Fawentus/fl-2021-hse-win/blob/HW04/have_not_initial_state) - [выходные данные](https://github.com/Fawentus/fl-2021-hse-win/blob/HW04/have_not_initial_state.out)
3) Автомат, символы которого не уникальны: [входные данные](https://github.com/Fawentus/fl-2021-hse-win/blob/HW04/not_unique_symbols) - [выходные данные](https://github.com/Fawentus/fl-2021-hse-win/blob/HW04/not_unique_symbols.out)
4) Неполный автомат: [входные данные](https://github.com/Fawentus/fl-2021-hse-win/blob/HW04/not_complete) - [выходные данные](https://github.com/Fawentus/fl-2021-hse-win/blob/HW04/not_complete.out)
5) Недетерминированный автомат: [входные данные](https://github.com/Fawentus/fl-2021-hse-win/blob/HW04/not_deterministic) - [выходные данные](https://github.com/Fawentus/fl-2021-hse-win/blob/HW04/not_deterministic.out)
6) Автомат, состояния которого не уникальны: [входные данные](https://github.com/Fawentus/fl-2021-hse-win/blob/HW04/not_unique_states) - [выходные данные](https://github.com/Fawentus/fl-2021-hse-win/blob/HW04/not_unique_states.out)
