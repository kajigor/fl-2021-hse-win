...
Примеры слов по автоматам из картинки ниже:  
```
vertex
1,F
2,T
...
,0,{'0'}
```
Некорректный вводы (забытый терминал, вершина не иницилизирована):
```
vertex
1,F
2,F
...
0 ---> 0 [ "0" ]
```
Некорректный вводы (забытый терминал, название вне алфавита, вершина не иницилизирована):
```
alphabet { "1", "2", "a", "b", "c"}
state q_1 { 1 }
state q_2 { 2 }
