...
States 00110000 00110001
Startvertex 00110000
Edge 00110000 00110001 01000100
Edge 00110001 00110001 01000100

```  
```
Alphabet 01011110
Terminalvertexes 01011010
States 01011010
Startvertex 01011010
Edge 01011010 01011010 01011110
...
```  
Общие комментарии: язык в целом очень удобный и хорошо описан.  
В синтаксический анализатор было бы неплохо добавить сообщения о том, какие именно проверки не прошел автомат.  
Также не выводится переход по последнему ребру автомата: если ввести следующее описание автомата   
```
Alphabet 01011110
Terminalvertexes 01011010
States 01011010
...
```  
Вывод: переход по последнему ребру пуст, хотя оно было введено корректно
```
Этот автомат удовлетвояет всем проверкам
Alphabet:
^ 
Terminal Vertexes:
Z 
